...
__decorate([
    type_graphql_1.Field(type => [game_entity_1.Game]),
    typegoose_1.prop({ default: [] }),
    __metadata("design:type", Array)
], User.prototype, "games", void 0);
__decorate([
    type_graphql_1.Authorized([user_roles_1.UserRoles.SUPER_ADMIN]),
    type_graphql_1.Field(type => [String]),
    typegoose_1.prop({ default: [user_roles_1.UserRoles.USER] }),
    __metadata("design:type", Array)
], User.prototype, "roles", void 0);
User = __decorate([
    typegoose_1.modelOptions({ options: { allowMixed: typegoose_1.Severity.ALLOW } }),
